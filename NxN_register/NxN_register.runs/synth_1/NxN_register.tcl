...
synth_design -top NxN_register -part xc7z010iclg225-1L
...
write_checkpoint -force -noxdef NxN_register.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file NxN_register_utilization_synth.rpt -pb NxN_register_utilization_synth.pb"
